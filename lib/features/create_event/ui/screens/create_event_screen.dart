...
class _CreateEventScreenState extends State<CreateEventScreen> {
 ...
 startTime: DateFormat("yyyy-MM-dd hh:mm a").parse("${_startDateController.text} ${_startTimeController.text}"),
  endTime: DateFormat("yyyy-MM-dd hh:mm a").parse("${_endDateController.text} ${_endTimeController.text}"),
